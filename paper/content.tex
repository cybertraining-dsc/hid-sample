\paperstatus{0} % a number from 0-100 indicating your status. 100
                % means completed
\paperchapter{TBD} % This section is typically a single keyword. from
                   % a small list. Consult with theinstructors about
                   % yours. They typically fill it out once your first
                   % text has been reviewed.
\hid{hid-sp18-000, hid-sp18-999} % all hids of the authors of this
                                ...
                                % listed first
\volume{9} % the volume of the proceedings in which this paper is to
           % be included
